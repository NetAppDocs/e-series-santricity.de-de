...
. Klicken Sie auf das Menü:Ellipsis-Symbol [Volume-Besitz ändern].
+
Das Fenster „Volume-Besitz ändern“ wird angezeigt. Alle Volumes auf dem Speicher-Array werden in diesem Dialogfeld angezeigt.
