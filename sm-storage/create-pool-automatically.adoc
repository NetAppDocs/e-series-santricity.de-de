...
* Wird nicht zugewiesene Kapazität erkannt, erscheint die Empfehlung zur automatischen Poolkonfiguration im Benachrichtigungsbereich (Glockensymbol oben im Fenster). Klicken Sie auf *Automatische Poolkonfiguration anzeigen*, um das Dialogfeld zu öffnen.
...
. Klicken Sie auf das Menü:Auslassungszeichen-Symbol [Pool-Autokonfiguration starten].
+
...
. Um weitere Eigenschaften des Pools anzuzeigen, klicken Sie auf den angezeigten Poolnamen.
+
