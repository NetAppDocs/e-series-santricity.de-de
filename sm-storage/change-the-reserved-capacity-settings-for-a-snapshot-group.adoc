...
. Wählen Sie die Snapshot-Gruppe aus, die Sie bearbeiten möchten, und klicken Sie dann auf das Menü:Ellipsis-Symbol[Einstellungen bearbeiten].
+
Das Fenster „Einstellungen für Snapshot-Gruppe bearbeiten“ wird angezeigt.
...
Der Name der Snapshot-Gruppe. Die Angabe eines Namens für die Snapshot-Gruppe ist erforderlich.
 ...
 a| 
Automatische Löschung von Snapshot-Images
 a| 
