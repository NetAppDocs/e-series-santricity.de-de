...
. Wählen Sie die Snapshot-Gruppe aus, für die Sie ein ausstehendes Snapshot-Image abbrechen möchten, und klicken Sie dann auf das Menü:Ellipsen-Symbol[Ausstehendes Snapshot-Image abbrechen].
