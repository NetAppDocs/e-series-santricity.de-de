...
. Wählen Sie das gespiegelte Paar-Volume aus, das Sie bearbeiten möchten, und klicken Sie dann auf das Menü:Ellipsen-Symbol[Einstellungen bearbeiten].
+
Das Fenster „Edit Mirrored Pair Volume Reserved Capacity Settings“ wird angezeigt.
...
Alarmschwelle für volle reservierte Kapazität
 a| 
Verwenden Sie die Leiste, um den Prozentsatz einzustellen, bei dem der System Manager eine Warnbenachrichtigung sendet, wenn die reservierte Kapazität für ein gespiegeltes Paar fast voll ist.
