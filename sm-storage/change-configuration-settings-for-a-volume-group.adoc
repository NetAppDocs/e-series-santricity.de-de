...
. Wählen Sie die Volume-Gruppe aus, die Sie bearbeiten möchten, und klicken Sie dann auf das Menü:Ellipsen-Symbol[Einstellungen bearbeiten].
+
Das Fenster „Volume-Gruppeneinstellungen bearbeiten“ wird angezeigt.

. Bearbeiten Sie die Einstellungen der Volume-Gruppe nach Bedarf.
+
.Felddetails
[%collapsible]
====
