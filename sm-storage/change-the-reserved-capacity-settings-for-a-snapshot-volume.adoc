...
. Wählen Sie das Snapshot-Volume aus, das Sie bearbeiten möchten, und klicken Sie dann auf das Menü:Ellipsis-Symbol[Einstellungen bearbeiten].
+
Das Fenster „Einstellungen für reservierte Snapshot-Volume-Kapazität bearbeiten“ wird angezeigt.
