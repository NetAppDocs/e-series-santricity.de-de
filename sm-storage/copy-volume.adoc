...
. Wählen Sie das Volume aus, das Sie als Quelle für den Vorgang Copy Volume verwenden möchten, und klicken Sie dann auf das Menü:Ellipsis-Symbol[Copy volume].
+
Das Fenster „Volume kopieren“ wird angezeigt.
...
Wählen Sie Menü:Storage[Operations in Progress], um den Fortschritt des Copy Volume-Vorgangs anzuzeigen. Dieser Vorgang kann längere Zeit dauern und die Systemleistung beeinträchtigen.
