...
. Wählen Sie das Speicherobjekt aus, für das Sie die reservierte Kapazität verringern möchten, und klicken Sie dann auf das Menü:Ellipsen-Symbol[Kapazität verringern].
+
Die Seite „Reservierte Kapazität verringern“ wird angezeigt.
