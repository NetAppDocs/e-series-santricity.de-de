...
. Klicken Sie auf das Menü:Ellipsis-Symbol [Initialize volumes].
+
...
Wählen Sie Menü:Storage[Operations in Progress], um den Fortschritt des aktuell für das ausgewählte Volume laufenden Initialisierungsvorgangs anzuzeigen. Dieser Vorgang kann längere Zeit dauern und die Systemleistung beeinträchtigen.
