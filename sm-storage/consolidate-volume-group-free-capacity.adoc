...
* Sie können das Dialogfeld "Freie Kapazität konsolidieren" auch von der Seite "Pools und Volumengruppen" aus öffnen, wie in der folgenden Aufgabe beschrieben.
...
. Klicken Sie auf das Menü:Ellipsen-Symbol [Freie Kapazität der Volumengruppe zusammenfassen].
+
...
Wählen Sie Menü:Storage[Operations in Progress], um den Fortschritt des Vorgangs „Consolidate Free Capacity“ anzuzeigen. Dieser Vorgang kann längere Zeit dauern und die Systemleistung beeinträchtigen.
