...
. Wählen Sie den Pool, die Volume-Gruppe oder den SSD-Cache aus, den Sie suchen möchten, und klicken Sie dann auf das Menü:Ellipsen-Symbol[Locator-Leuchten einschalten].
+
