...
. Wählen Sie das Konsistenzgruppenmitglied-Volume aus, das Sie bearbeiten möchten, und klicken Sie dann auf das Menü:Ellipsen-Symbol[Einstellungen bearbeiten].
+
Das Fenster „Volume des Konsistenzgruppenmitglieds bearbeiten“ wird angezeigt.
...
| Einstellung | Beschreibung 
 ...
 a| 
Alarmschwelle für volle reservierte Kapazität
 a| 
Verwenden Sie die Leiste, um den Prozentsatz einzustellen, bei dem der System Manager eine Warnbenachrichtigung sendet, wenn die reservierte Kapazität für ein Mitgliedsvolume fast voll ist.
