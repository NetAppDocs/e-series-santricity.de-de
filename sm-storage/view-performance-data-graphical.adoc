...
* *Anwendungs- und Workload-Ansicht* -- Zeigt eine Liste logischer Objekte (Volumes) an, gruppiert nach den von Ihnen definierten Anwendungstypen und Workloads.
...
. Wählen Sie die Registerkarte *Logical View*, die Registerkarte *Physical View* oder die Registerkarte *Applications and workloads View*.
+
