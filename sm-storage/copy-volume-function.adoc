...
|===
^1^ Sie können die Snapshot-Volume-Kopie erst verwenden, nachdem der Online-Kopiervorgang abgeschlossen ist.

^2^ Wenn das Quell-Volume ein primäres Volume ist, muss die Kapazität des Ziel-Volumes der nutzbaren Kapazität des Quell-Volumes entsprechen oder größer sein.
