...
+
Die Seite „Volumes erstellen“ wird angezeigt.
...
. Wenn Ihre Arbeitslast mit einem unterstützten Anwendungstyp verknüpft ist, geben Sie die angeforderten Informationen ein; andernfalls gehen Sie zu <<Schritt 3: Volumes hinzufügen>>.




== Schritt 3: Volumes hinzufügen
...
+
** 2.048 Volumes (EF80, EF600, EF600C und E5700 series)
** 1.024 Volumes (EF50, EF300 und EF300C)
...
DA erhöht die Datenintegrität im gesamten Storage-System. DA ermöglicht es dem Storage-Array, Fehler zu überprüfen, die auftreten können, wenn Daten durch die Controller an die Laufwerke übertragen werden. Die Verwendung von da für das neue Volume stellt sicher, dass alle Fehler erkannt werden.
 ...
 a| 
Ressource bereitgestellt (EF80, EF50, EF300 und EF600 only)
 a| 
*Ja* erscheint neben „Ressource bereitgestellt“ nur, wenn die Laufwerke diese Option unterstützen. Ressourcenbereitstellung ist eine Funktion, die in den Speichersystemen EF80, EF50, EF300 und EF600 verfügbar ist und es ermöglicht, Volumes sofort ohne Hintergrundinitialisierung zu verwenden.

|===
====
** *Anwendungsspezifische Arbeitslast* -- Klicken Sie auf *Volumes bearbeiten*, um die vom System empfohlenen Volumes und Merkmale für die ausgewählte Arbeitslast zu ändern, hinzuzufügen oder zu löschen.
+
.Felddetails
[%collapsible]
====
...
Volume-Typ gibt den Volume-Typ an, der für einen applikationsspezifischen Workload erstellt wurde.
 ...
 a| 
Volumenblockgröße (EF80, EF50, EF300 und EF600 nur)
 a| 
Zeigt die Block-Größen, die für das Volume erstellt werden können:
...
+
Die SMcli ist direkt über den SANtricity System Manager verfügbar. Diese herunterladbare Version der SMcli ist auf EF80, EF50, E4000, EF600, EF600C, EF300, EF300C, E5700, EF570, E2800 und EF280 Controllern verfügbar. Um die SMcli innerhalb des SANtricity System Manager herunterzuladen, wählen Sie *Einstellungen* > *System* und *Add-ons* > *Command Line Interface*.
