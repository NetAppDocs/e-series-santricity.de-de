...
+
** Wählen Sie im linken Bereich Menü:Storage[Volumes]. Wählen Sie das Objekt (Base Volume oder Snapshot Konsistenzgruppe) aus und klicken Sie dann auf das Menü:Ellipsis Icon[Create instant snapshot].
** Wählen Sie im linken Bereich Menü:Storage[Snapshots]. Wählen Sie die Registerkarte *Snapshot Images* und anschließend Menü:Create[Instant snapshot Image].
+
