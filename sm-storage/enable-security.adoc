...
. Wählen Sie den Pool oder die Volume-Gruppe aus, für die Sie die Sicherheit aktivieren möchten, und klicken Sie dann auf menu:ellipsis icon[Enable security].
+
