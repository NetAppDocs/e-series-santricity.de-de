...
. Wählen Sie den Host aus, den Sie bearbeiten möchten, und klicken Sie dann auf das Menü:Ellipsis-Symbol[Einstellungen bearbeiten].
+
Es erscheint ein Fenster, das die aktuellen Host-Einstellungen anzeigt.
