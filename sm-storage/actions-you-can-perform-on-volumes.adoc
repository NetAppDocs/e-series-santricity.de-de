...
+
Sie fügen einem Volume Kapazität hinzu, indem Sie im linken Bereich menu:Storage[Volumes] auswählen und dann das menu:ellipsis icon[Kapazität erhöhen] für das Volume auswählen.
...
Beim Kopieren von Volumes erstellen Sie eine zeitpunktgenaue Kopie zweier separater Volumes, des Quell-Volumes und des Ziel-Volume, auf demselben Storage-Array. Sie können Volumes kopieren, indem Sie menu:Storage[Volumes] auswählen und dann das menu:ellipsis icon[Copy volume] auswählen.
...
Sie können Volumes initialisieren, indem Sie Menü:Storage[Volumes > Auslassungszeichen-Symbol > Volumes initialisieren] auswählen.
...
Sie können Volumes neu verteilen, indem Sie Menü:Storage[Volumes > Auslassungszeichen-Symbol > Volumes neu verteilen] auswählen.



== Änderung der Volume-Eigentümerschaft

Durch Ändern des Besitzers eines Volumes wird der bevorzugte Controller-Besitzer des Volumes geändert. Der bevorzugte Controller-Besitzer eines Volumes wird im Menü:Storage[Volumes > ellipsis icon > Edit settings] aufgeführt.

Sie können den Besitzer eines Volumes ändern, indem Sie Menü:Storage[Volumes > Auslassungszeichen-Symbol > Volume-Eigentümer ändern] auswählen.
...
Wählen Sie Menü:Storage [Volumes > ellipsis icon > Cache-Einstellungen ändern], um die folgenden Cache-Einstellungen zu ändern:
