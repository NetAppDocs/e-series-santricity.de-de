...
Eine Volume-Gruppe kann Laufwerke enthalten, die für da-fähig sind oder nicht für da-fähig sind, aber alle Laufwerke müssen für die Verwendung dieser Funktion als da-fähig sein.
 ...
 a| 
Ressourcenbereitstellungsfähig (EF80, EF50, EF300 und EF600 nur)
 a| 
Zeigt an, ob die Ressourcenbereitstellung für diese Gruppe verfügbar ist. Ressourcenbereitstellung ist eine Funktion, die in den Speichersystemen EF80, EF50, EF300 und EF600 verfügbar ist und es ermöglicht, Volumes sofort ohne Hintergrundinitialisierung zu verwenden.
