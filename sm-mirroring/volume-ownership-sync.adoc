...
---
= Erfahren Sie mehr über den Volume-Besitz bei der synchronen Spiegelung in der SANtricity-Software
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[NOTE]
====
Diese Funktion ist für synchrones Spiegeln auf den Speichersystemen EF80, EF50, EF600/EF600C oder EF300/EF300C nicht verfügbar.
