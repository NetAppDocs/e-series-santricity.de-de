...
. Wählen Sie das Speicherobjekt aus, für das Sie die reservierte Kapazität erhöhen möchten, und klicken Sie dann auf das Menü:Ellipsis-Symbol[Reservierte Kapazität erhöhen].
+
Die Seite „Reservierte Kapazität erhöhen“ wird angezeigt.
