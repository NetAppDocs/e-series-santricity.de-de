...
[NOTE]
====
Synchrones Spiegeln ist auf dem Speicherarray EF80, EF50, EF600/EF600C oder EF300/EF300C nicht verfügbar.
...
[NOTE]
====
Die synchrone Spiegelung ist auf dem EF80, EF50, EF600/EF600C oder EF300/EF300C Speichersystem nicht verfügbar.
