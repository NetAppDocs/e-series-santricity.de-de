...
Das Latenzdiagramm liefert Latenz-Statistiken in Millisekunden (ms) für Volumes, Volume-Gruppen, Pools, Anwendungen und Workloads. Dieses Diagramm wird in den Registerkarten „Logische Ansicht“, „Physische Ansicht“ und „Anwendungs- und Workload-Ansicht“ angezeigt.
...
Das MiB/s-Diagramm zeigt Statistiken zur Übertragungsgeschwindigkeit in Mebibyte pro Sekunde an. Auf der Startseite zeigt dieses Diagramm Statistiken für das Storage Array an. In den Registerkarten „Logische Ansicht“, „Physische Ansicht“ und „Anwendungs- und Workload-Ansicht“ der Leistungsseite zeigt dieses Diagramm Statistiken für das Storage Array, Volumes, Volume-Gruppen, Pools, Anwendungen und Workloads an.
...
Das CPU-Diagramm zeigt Statistiken zur Verarbeitungskapazität für jeden Controller (Controller A und Controller B) an. CPU ist eine Abkürzung für _central processing unit_. Auf der Startseite zeigt dieses Diagramm Statistiken für das Storage-Array an. Auf der Registerkarte „Physische Ansicht“ der Leistungsseite zeigt dieses Diagramm Statistiken für das Storage-Array und die Laufwerke an.
...
Das Headroom-Diagramm bezieht sich auf die verbleibende Leistungskapazität der Speicherarray-Controller. Dieses Diagramm ist auf der Startseite und auf der Registerkarte „Physische Ansicht“ der Leistungsseite sichtbar.
