...
. Wählen Sie in der Dropdown-Liste „Standardmäßig anzuzeigender Zeitbereich für Leistungsdiagramme“ entweder *5 Minuten*, *1 Stunde*, *8 Stunden*, *1 Tag* oder *7 Tage* aus und bestätigen Sie, dass Sie den Vorgang ausführen möchten.
