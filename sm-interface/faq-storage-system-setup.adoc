...
Sie können Leistungsdaten nach Anwendung und Workload anzeigen, um die Latenz, IOPS und MiB/s von Anwendungen und ihren zugehörigen Workloads zu bewerten, um die Leistung zu optimieren. Merkmale wie E/A-Typ, Segmentgröße, Controller-Zugehörigkeit sowie Lese- und Schreibcache sind in der Volume-Konfiguration enthalten.
