...
---
= Bearbeiten Sie Verzeichnisservereinstellungen und Rollenzuordnungen im SANtricity Unified Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Schritte
. Wählen Sie im linken Bereich menu:Settings[Access Management].
