...
DULBE
 a| 
Deallocated or Unwritten Logical Block Error (DULBE) ist eine Option auf NVMe-Laufwerken, die es dem Speicherarray EF80, EF50, EF300/EF300C oder EF600/EF600C ermöglicht, ressourcenbereitgestellte Volumes zu unterstützen.
