...
DULBE-fähig
 a| 
Gibt an, ob die Option für Deallocated or Unwritten Logical Block Error (DULBE) aktiviert (Ja) oder nicht (Nein) ist. DULBE ist eine Option auf NVMe-Laufwerken, die es dem Speicher-Array EF80, EF50, EF300 oder EF600 ermöglicht, ressourcenbereitgestellte Volumes zu unterstützen.
