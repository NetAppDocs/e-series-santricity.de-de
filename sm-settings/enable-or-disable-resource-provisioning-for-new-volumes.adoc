...
Resource-Bereitstellung ist eine Funktion, die in den EF80-, EF50-, EF300/EF300C- und EF600/EF600C-Speicher-Arrays verfügbar ist und es ermöglicht, Volumes sofort zu verwenden, ohne dass ein Hintergrund-Initialisierungsprozess erforderlich ist. Alle dem Volume zugewiesenen Laufwerksblöcke werden freigegeben (unmapped), was die SSD-Lebensdauer verbessern und die maximale Schreibleistung erhöhen kann.
...
.Schritte
. Wählen Sie im linken Bereich Menü:Einstellungen[System].
