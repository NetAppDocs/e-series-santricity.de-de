...
[NOTE]
====
Synchrones Spiegeln ist auf dem EF80, EF50, EF600/EF600C oder EF300/EF300C Storage Array nicht verfügbar.
...
* Auf primären und sekundären Volumes darf die Ressourcenpartitionierung nicht aktiviert sein.
