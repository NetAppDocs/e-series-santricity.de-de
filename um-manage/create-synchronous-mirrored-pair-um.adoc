...
[NOTE]
====
Diese Funktion ist auf dem Speichersystem EF80, EF50, EF600/EF600C oder EF300/EF300C nicht verfügbar.
...
Gehen Sie zu System Manager und Menü:Storage[Laufende Vorgänge], um den Fortschritt des synchronen Spiegelungsvorgangs anzuzeigen. Dieser Vorgang kann längere Zeit dauern und die Systemleistung beeinträchtigen.
